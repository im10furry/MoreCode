...
fn sample_sub_task() -> SubTask {
    SubTask {
        ...
        target_files: vec!["crates/mc-core/src/task.rs".to_string()],
    ...
    ProjectContext {
        ...
        architecture: ArchitecturePattern {
            ...
            layers: vec![ArchitectureLayer {
                ...
                modules: vec!["mc-core".to_string()],
                depends_on: vec![],
            }],
            design_decisions: vec!["keep mc-core lightweight".to_string()],
        },
        dependency_graph: DependencyGraph {
            nodes: vec!["mc-core".to_string(), "mc-communication".to_string()],
            edges: vec![DependencyEdge {
                from: "mc-communication".to_string(),
                to: "mc-core".to_string(),
        ...
        risk_areas: RiskAreas {
            items: vec![RiskArea {
                file: "crates/mc-core/src/error.rs".to_string(),
...
fn sample_execution_plan() -> ExecutionPlan {
    ...
    ExecutionPlan {
        ...
        context_allocations: vec![ContextAllocation {
            ...
            agent_type: AgentType::Coder,
            token_budget: 8_000,
            required_files: vec!["crates/mc-core/src/task.rs".to_string()],
...
fn serde_json_compatibility_for_core_structs() {
    let task = TaskDescription {
        id: "task-1".to_string(),
        user_input: "implement mc-core".to_string(),
        intent: TaskIntent::FeatureAddition,
        complexity: Complexity::Complex,
        affected_files: vec!["crates/mc-core/src/lib.rs".to_string()],
    ...
    let result = TaskResult {
        ...
        success: true,
        data: json!({ "files": 3 }),
        changed_files: vec!["crates/mc-core/src/task.rs".to_string()],
    ...
    let report = AgentExecutionReport {
        ...
        relevant_files: vec!["crates/mc-core/src/task.rs".to_string()],
